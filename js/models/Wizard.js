...
class WizardOrcamento {
  ...
  addTabFunction(nome, funcao) {
    this.tabShowFunctions.push(new TabFunction(nome, funcao));
  }
  ...
  refreshAnimation($wizard, index) {
    ...
    if ($current == 1 || (w.mobile_device == true && (index % 2 == 0))) {
      move_distance -= 8;
    } else if ($current == total_steps || (w.mobile_device == true && (index % 2 == 1))) {
      move_distance += 8;
    }
